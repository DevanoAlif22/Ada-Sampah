...
<body style="background-color: #68b984;">
          ...
          <div style=" width: 95%; margin:auto; margin-top:10px; margin-bottom:10px;" class="modal-body2">
            ...
            <div class="mb-3">
              ...
              <select class="form-select" name="kota" id="pkota">
                ...
                <option value="Email Fery">Email Fery</option>
                <option value="Email Davano">Email Davano</option>
                <option value="Email Devano">Email Devano</option>
              </select>
            </div>
            <div class="mb-3">
              <i class="fa-solid fa-location-dot fa-1xs lokasi"></i>
              <label class="form-label">Titik Lokasi</label>
              <input type="text" class="form-control" required autocomplete="off" name="lokasi" placeholder="ITATS, Jalan Arief Rahman Hakim, Klampis Ngasem, Kota Surabaya, Jawa Timur">
            </div>
            <div class="mb-3">
  ...
  <div class="kotajatim">
    <div class="judul3">
      ...
      <p>Memiliki 29 Kabupaten dan 9 Kota </p>
          ...
          <div class="penjelasanweb">
            <div class="isijelas">
              ...
              <div class="judul4">
                ...
                <p>Jawa Timur adalah sebuah provinsi di bagian timur Pulau Jawa, Indonesia. Provinsi Jawa Timur didirikan pada tanggal 4 Maret 1950 berdasarkan dasar hukum UU No. 2 Tahun 1950. Ibukota Provinsi Jawa Timur adalah Kota Surabaya yang juga merupakan Kota Terbesar kedua di Indonesia setelah DKI Jakarta. Secara administratif Jawa Timur terbagi menjadi 29 kabupaten dan 9 kota.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="penjelasanweb">
            <div class="isijelas">
              ...
              <div class="judul4">
                ...
                <p style="padding-bottom: 24px;">Untuk membantu pengembangan fitur dan kemajuan dari web AdaSampah bisa donasi lewat </br> whatsapp : 0895366141915 </br> Email : devanorama123@gmail.com </br> BRI DEVANO : 3168 0101 4668 502 </p>
              </div>
            </div>
          </div>
        </div>
